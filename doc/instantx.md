...
This mechanism has been integrated into Bitcore-Node-EDC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/EDC-Project/insight-api-EDC#web-socket-api](https://github.com/EDC-Project/insight-api-EDC#web-socket-api) 
* API: [https://github.com/EDC-Project/insight-api-EDC#instantx-transactions](https://github.com/EDC-Project/insight-api-EDC#instantx-transactions)
...
By default, the Edccore daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Edccore daemon:
