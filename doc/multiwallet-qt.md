...
In order to support loading of multiple wallets in EDC-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is EDC.cpp.
...
Changes to EDC.cpp
----------------------
EDC.cpp is the entry point into EDC-qt, and as such, will require some minor modifications to provide hooks for
