Contributing to Edccore
============================

The Edccore project operates an open contributor model where anyone is
...
The following applies to code changes to the Edccore project, and is not to be
confused with overall EDC Network Protocol consensus changes.

Whether a pull request is merged into Edccore rests with the project merge
...
Patches that change EDC consensus rules are considerably more involved than
...
Where a patch set proposes to change the EDC consensus, it must have been
...
The project leader is the release manager for each Edccore release.
