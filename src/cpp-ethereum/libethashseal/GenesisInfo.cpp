...
#include "genesis/EDCMainNetwork.cpp"
#include "genesis/EDCTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::EDCMainNetwork: return c_genesisInfoEdcMainNetwork;
	case Network::EDCTestNetwork: return c_genesisInfoEdcTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::EDCMainNetwork: return c_genesisStateRootEdcMainNetwork;
	case Network::EDCTestNetwork: return c_genesisStateRootEdcTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
