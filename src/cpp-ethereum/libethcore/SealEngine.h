...
////////////////////////////////////////////////////////////// // EDC
	void setEdcSchedule(EVMSchedule _EDCSchedule) const { EDCSchedule = _EDCSchedule; }

	EVMSchedule& getEdcSchedule() const { return EDCSchedule; }
...
private:
	...
	mutable EVMSchedule EDCSchedule; // EDC
