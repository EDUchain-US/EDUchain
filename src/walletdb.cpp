...
bool CWalletDB::WriteEdcNodeConfig(std::string sAlias, const CEdcNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadEdcNodeConfig(std::string sAlias, CEdcNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseEdcNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
