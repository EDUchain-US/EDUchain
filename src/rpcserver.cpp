...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Edc features */
        {"EDC", "masternode", &masternode, true, true, false},
        //{"EDC", "masternodelist", &masternodelist, true, true, false},
        //{"EDC", "mnbudget", &mnbudget, true, true, false},
        //{"EDC", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"EDC", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"EDC", "mnsync", &mnsync, true, true, false},
        {"EDC", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"EDC", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use EDCd, or the -server option to EDC-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> EDC-cli " + methodname + " " + args + "\n";
}
