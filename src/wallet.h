...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOTMN = 4, // ONLY_NONDENOMINATED_NOT10000IFMN = 4, ONLY_NONDENOMINATED and not 10000 EDC at the same time
};
...
public:
    ...
    std::map<std::string, CEdcNodeConfig> mapMyEdcNodes;
    bool AddEdcNodeConfig(CEdcNodeConfig nodeConfig);
