...
/////////////////////////////////////////// EDC
#include <EDC/EDCstate.h>
#include <EDC/EDCDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <EDC/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<EdcState> globalState;
...
using ExtractEdcTX = std::pair<std::vector<EdcTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
static const int64_t DARKSEND_COLLATERAL = (16120*COIN); //16120 EDC
...
inline int64_t GetMNCollateral(int nHeight) {
    ...
    return nHeight>=30000 ? 50000 : 1999999;
}
...
void EnforceContractVoutLimit(ByteCodeExecResult& bcer, ByteCodeExecResult& bcerOut, const dev::h256& oldHashEdcRoot,
                              const dev::h256& oldHashStateRoot, const std::vector<EdcTransaction>& transactions);
...
class EdcTxConverter{

public:

    EdcTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionEdcTransactions(ExtractEdcTX& EDCTx);
...
private:
    ...
    EdcTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<EdcTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
