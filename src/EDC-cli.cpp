...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Edccore RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  EDC-cli [options] <command> [params]  " + _("Send command to Edccore") + "\n" +
                        "  EDC-cli [options] help                " + _("List commands") + "\n" +
                        "  EDC-cli [options] help <command>      " + _("Get help for a command") + "\n";
