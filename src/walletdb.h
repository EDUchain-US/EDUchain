...
public:
    ...
    bool WriteEdcNodeConfig(std::string sAlias, const CEdcNodeConfig& nodeConfig);
    bool ReadEdcNodeConfig(std::string sAlias, CEdcNodeConfig& nodeConfig);
    bool EraseEdcNodeConfig(std::string sAlias);
