                              ...
                              isRemembered(false)
{
    ...
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\"><b>\"Licensor\"</b> means Edccore, with its main address \
    ...
    eulaInfo += tr("<p style=\"line-height:130\"><b>\"Software\"</b> means (a) all of the contents of the files, \
                   ...
                   limited to (i) Edccore or third party computer information or software; (ii) digital images, \
                   ...
                   Edccore (collectively, \"Updates\"). </p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    ...
    eulaInfo += tr("<p style=\"line-height:130\"><b>\"Permitted Number\"</b> means one (1) unless otherwise indicated under \
                   a valid license (e.g. volume license) granted by Edccore.</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    ...
    eulaInfo += tr("<p style=\"line-height:130\">As long as you comply with the terms of this End User License Agreement (the \
                   \"Agreement\"), Edccore grants to you a non-exclusive license to Use the Software for the purposes described \
    ...
    eulaInfo += tr("<p style=\"line-height:130\">You may install one copy of the Software on your computer file server for the \
                   ...
                   to use this copy of the Software through a valid license from Edccore; and</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    ...
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">To the extent that the Software includes Edccore Edcgate software, (i) you may customize the \
                   installer for such software in accordance with the restrictions found at <a href=\"https://EDCcore.io\">https://EDCcore.io</a> \
                   ...
                   or create a new installer for any of such software, (ii) such software is licensed and distributed by Edccore, and (iii) you are \
                   ...
                   however, such use is authorized with Edccore, Edccore Edcgate, and other current and future Edccore products. For information on \
                   how to distribute Edcgate please refer to the sections entitled \"How to Distribute Edcgate\" at \
                   <a href=\"https://EDCcore.io\">https://EDCcore.io</a>.</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\"><br><b>3.	Intellectual Property Rights</b></p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">The Software and any copies that you are authorized by Edccore to make are the intellectual property \
                    of and are owned by Edccore and its suppliers. The structure, organization and code of the Software are the valuable trade secrets \
                    and confidential information of Edccore and its suppliers. The Software is protected by copyright, including without limitation by \
    ...
    eulaInfo += tr("<p style=\"line-height:130\">Any copies that you are permitted to make pursuant to this Agreement must contain the same copyright \
                   ...
                   first requested Edccore to provide the information necessary to achieve such operability and Edccore has not made such information \
                   available.</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">Edccore has the right to impose reasonable conditions and to request a reasonable fee before providing \
                    such information. Any information supplied by Edccore or obtained by you, as permitted hereunder, may only be used by you for the \
                    ...
                    to the expression of the Software. Requests for information should be directed to the Edccore Customer Support Department. Trademarks \
    ...
    eulaInfo += tr("<p style=\"line-height:130\">If the Software supports multiple platforms or languages, if you receive the Software on multiple media, if \
                    ...
                    the Update are also transferred to such party or computer; and you acknowledge that any obligation Edccore may have to support the previous version \
                    of the Software may be ended upon availability of the Update.</p>");

    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\"><br><b>6.	NO WARRANTY</b></p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">The Software is being delivered to you \"AS IS\" and Edccore makes no warranty as to its use or performance. Edccore AND \
                    ...
                    REPRESENTATION OR TERM TO THE EXTENT TO WHICH THE SAME CANNOT OR MAY NOT BE EXCLUDED OR LIMITED BY LAW APPLICABLE TO YOU IN YOUR JURISDICTION, Edccore \
    ...
    eulaInfo += tr("<p style=\"line-height:130\">If the product you have received with this license is pre-commercial release or beta Software (\"Pre-release Software\"), then \
                    ...
                    You acknowledge that the Software is a pre-release version, does not represent final product from Edccore, and may contain bugs, errors and other problems that \
                    could cause system or other failures and data loss. Consequently, the Pre-release Software is provided to you \"AS-IS\", and Edccore disclaims any warranty or \
                    liability obligations to you of any kind. WHERE LEGALLY LIABILITY CANNOT BE EXCLUDED FOR PRE-RELEASE SOFTWARE, BUT IT MAY BE LIMITED, EDCCORE'S LIABILITY AND \
                    THAT OF ITS SUPPLIERS SHALL BE LIMITED TO THE SUM OF FIFTY DOLLARS (U.S. $50) IN TOTAL. You acknowledge that Edccore has not promised or guaranteed to you that \
                    Pre-release Software will be announced or made available to anyone in the future, that Edccore has no express or implied obligation to you to announce or \
                    introduce the Pre-release Software and that Edccore may not introduce a product similar to or compatible with the Pre-release Software. Accordingly, you \
                    ...
                    done entirely at your own risk. During the term of this Agreement, if requested by Edccore, you will provide feedback to Edccore regarding testing and use of \
                    ...
                    the Edccore Serial Agreement for Unreleased Products, your use of the Software is also governed by such agreement. You agree that you may not and certify that \
                    ...
                    release by Edccore of a publicly released commercial version of the Software, whether as a stand-alone product or as part of a larger product, you agree to \
                    return or destroy all earlier Pre-release Software received from Edccore and to abide by the terms of the End User License Agreement for any such later versions \
                    ...
                    when such date is earlier than the date for Edccore's first commercial shipment of the publicly released (commercial) Software.</p>");


    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\"><br><b>8.	LIMITATION OF LIABILITY</b></p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">IN NO EVENT WILL EDCCORE OR ITS SUPPLIERS BE LIABLE TO YOU FOR ANY DAMAGES, CLAIMS OR COSTS WHATSOEVER OR ANY CONSEQUENTIAL, INDIRECT, \
                   INCIDENTAL DAMAGES, OR ANY LOST PROFITS OR LOST SAVINGS, EVEN IF AN EDCCORE REPRESENTATIVE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH LOSS, DAMAGES, CLAIMS OR \
                   COSTS OR FOR ANY CLAIM BY ANY THIRD PARTY. THE FOREGOING LIMITATIONS AND EXCLUSIONS APPLY TO THE EXTENT PERMITTED BY APPLICABLE LAW IN YOUR JURISDICTION. EDCCORE'S \
                   ...
                   contained in this Agreement limits Edccore's liability to you in the event of death or personal injury resulting from Edccore's negligence or for the tort of \
                   deceit (fraud). Edccore is acting on behalf of its suppliers for the purpose of disclaiming, excluding and/or limiting obligations, warranties and liability as \
                   ...
                   end of this Agreement, if any, or contact Edccore's Customer Support Department.</p>");
    ...
    eulaInfo += tr("<p style=\"line-height:130\">If any part of this Agreement is found void and unenforceable, it will not affect the validity of the balance of the Agreement, \
                   ...
                   This Agreement may only be modified by a writing signed by an authorized officer of Edccore. Updates may be licensed to you by Edccore with additional or \
                   different terms. This is the entire agreement between Edccore and you relating to the Software and it supersedes any prior representations, discussions, \
    ...
    eulaInfo += tr("<p style=\"line-height:130\">The Software and Documentation are \"Commercial Items,\" as that term is defined at 48 C.F.R. ") + QString::fromUtf8("§") +
                ...
                laws of the United States. For U.S. Government End Users, Edccore agrees to comply with all applicable equal opportunity laws including, if appropriate, the \
    ...
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">If you are a business or organization, you agree that upon request from Edccore or Edccore 's authorized representative, you will \
                   within thirty (30) days fully document and certify that use of any and all Edccore Software at the time of the request is in conformity with your valid licenses \
                   from Edccore.</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">If you have any questions regarding this Agreement or if you wish to request any information from Edccore please use the address \
                    and contact information included with this product to contact the Edccore office serving your jurisdiction.</p>");
    eulaInfo += tr("<p style=\"line-height:30\"></p>");
    eulaInfo += tr("<p style=\"line-height:130\">Edccore, Edcgate, and all other Edccore's products are either registered trademarks or trademarks of Edccore in the United States, \
...
void Eula::showDialog()
{
    ...
    QString currentVersion = tr("EDC_") + QString::fromStdString(strprintf("%d%d%d%d",
    ...
    if (settings.contains(tr("EDCVersion")))
    {
        QString storeVersion = settings.value(tr("EDCVersion")).toString();
        ...
        else
        {
            ...
            settings.setValue(tr("EDCVersion"), currentVersion);
        }
    }
    else
    {
