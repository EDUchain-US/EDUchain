...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(EDC);
    unitlist.append(mEDC);
    unitlist.append(uEDC);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case EDC:
            return QString("tEDC");
        case mEDC:
            return QString("mtEDC");
        case uEDC:
            return QString::fromUtf8("μtEDC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case EDC:
            return QString("EDC");
        case mEDC:
            return QString("Milli-EDC (1 / 1" THIN_SP_UTF8 "000)");
        case uEDC:
            return QString("Micro-EDC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case EDC:
            return QString("TestEDCs");
        case mEDC:
            return QString("Milli-TestEDC (1 / 1" THIN_SP_UTF8 "000)");
        case uEDC:
            return QString("Micro-TestEDC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
