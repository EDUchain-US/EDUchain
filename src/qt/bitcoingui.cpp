                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    resize(1200, 735);
    QString windowTitle = tr("Edccore") + " - ";
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a EDC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and EDC: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Edccore"), this);
    aboutAction->setStatusTip(tr("Show information about Edccore"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for EDC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your EDC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified EDC addresses"));
    ...
    openAction->setStatusTip(tr("Open a EDC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Edccore help message to get a list with possible EDC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Edccore client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive())
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Edccore network", "", count));
    else
...
{
    QString strTitle = tr("Edccore"); // default title
