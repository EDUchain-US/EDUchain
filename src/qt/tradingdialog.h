...
#ifndef EDC_TRADINGDIALOG_H
#define EDC_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfEDCOnTradingTab();
    ...
    void showBalanceOfEDCOnSendTab();
    void showBalanceOfEDCOnBalanceTab();
    ...
    QString BuyEDC(QString OrderType, double Quantity, double Rate);
    QString SellEDC(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"EDC/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"EDC/BTC\"}"));// "{\"gender\":\"male\"}");
