...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Edccore EDC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  EDC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded EDC transaction") + "\n" +
                               "  EDC-tx [options] -create [commands]   " + _("Create hex-encoded EDC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded EDC transaction
