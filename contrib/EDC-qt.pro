...
RESOURCES += src/qt/EDC.qrc src/qt/EDC_locale.qrc

TRANSLATIONS += src/qt/locale/EDC_bg.ts \
                src/qt/locale/EDC_de.ts \
                src/qt/locale/EDC_en.ts \
                src/qt/locale/EDC_es.ts \
                src/qt/locale/EDC_fi.ts \
                src/qt/locale/EDC_fr.ts \
                src/qt/locale/EDC_it.ts \
                src/qt/locale/EDC_ja.ts \
                src/qt/locale/EDC_pl.ts \
                src/qt/locale/EDC_pt.ts \
                src/qt/locale/EDC_ru.ts \
                src/qt/locale/EDC_sk.ts \
                src/qt/locale/EDC_sv.ts \
                src/qt/locale/EDC_vi.ts \
                src/qt/locale/EDC_zh_CN.ts \
                src/qt/locale/EDC_zh_TW.ts
