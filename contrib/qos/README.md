...
This means one can have an always-on EDCd instance running, and another local EDCd/EDC-qt instance which connects to this node and receives blocks from it.
